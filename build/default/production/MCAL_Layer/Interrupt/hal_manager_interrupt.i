# 1 "MCAL_Layer/Interrupt/hal_manager_interrupt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Interrupt/hal_manager_interrupt.c" 2
...
# 1 "MCAL_Layer/Interrupt/hal_manager_interrupt.h" 1
# 13 "MCAL_Layer/Interrupt/hal_manager_interrupt.h"
...
# 13 "MCAL_Layer/Interrupt/hal_manager_interrupt.h" 2
# 22 "MCAL_Layer/Interrupt/hal_manager_interrupt.h"
void INT0_ISR(void);
void INT1_ISR(void);
void INT2_ISR(void);
void RB4_ISR(void);
...
void __attribute__((picinterrupt(("")))) InterruptManager(void){
    ...
    if((PIE1bits.ADIE == 1) && (PIR1bits.ADIF == 1)) ADC_ISR();
    if((INTCONbits.TMR0IE == 1) && (INTCONbits.TMR0IF == 1)) TIMER0_ISR();
    if((PIE1bits.TMR1IE == 1) && (PIR1bits.TMR1IF == 1)) TIMER1_ISR();
    if((PIE1bits.TMR2IE == 1) && (PIR1bits.TMR2IF == 1)) TIMER2_ISR();
    if((PIE2bits.TMR3IE == 1) && (PIR2bits.TMR3IF == 1)) TIMER3_ISR();

...
# 1 "MCAL_Layer/ADC/../std_types.h" 1
# 13 "MCAL_Layer/ADC/../std_types.h"
# 1 "MCAL_Layer/ADC/../std_libraries.h" 1
# 13 "MCAL_Layer/ADC/../std_libraries.h"
...
# 16 "MCAL_Layer/ADC/../std_libraries.h" 2
# 13 "MCAL_Layer/ADC/../std_types.h" 2

# 1 "MCAL_Layer/ADC/../compiler.h" 1
# 14 "MCAL_Layer/ADC/../std_types.h" 2
...
# 1 "MCAL_Layer/ADC/../device_config.h" 1
# 14 "MCAL_Layer/ADC/hal_adc.h" 2

# 1 "MCAL_Layer/ADC/hal_adc_cfg.h" 1
# 15 "MCAL_Layer/ADC/hal_adc.h" 2

# 1 "MCAL_Layer/ADC/../Interrupt/hal_internal_interrupt.h" 1
# 13 "MCAL_Layer/ADC/../Interrupt/hal_internal_interrupt.h"
# 1 "MCAL_Layer/ADC/../Interrupt/hal_interrupt_cfg.h" 1
# 18 "MCAL_Layer/ADC/../Interrupt/hal_interrupt_cfg.h"
# 1 "MCAL_Layer/ADC/../Interrupt/../hal_gpio.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/../hal_gpio.h"
# 1 "MCAL_Layer/ADC/../GPIO/hal_gpio_cfg_inter.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/../hal_gpio.h" 2
# 41 "MCAL_Layer/ADC/../Interrupt/../hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 90 "MCAL_Layer/ADC/../Interrupt/../hal_gpio.h"
...
# 18 "MCAL_Layer/ADC/../Interrupt/hal_interrupt_cfg.h" 2

# 1 "MCAL_Layer/ADC/../Interrupt/hal_interrupt_gen_cfg.h" 1
# 19 "MCAL_Layer/ADC/../Interrupt/hal_interrupt_cfg.h" 2
# 60 "MCAL_Layer/ADC/../Interrupt/hal_interrupt_cfg.h"
typedef enum{
    INTERRUPT_Low_Priority = 0,
    INTERRUPT_High_Priority,
}Interrupt_Priority_cfg;
# 13 "MCAL_Layer/ADC/../Interrupt/hal_internal_interrupt.h" 2
...
static __attribute__((inline)) void adc_input_channel_pin_conf(const adc_select_channel_t channel_adc);
static __attribute__((inline)) void adc_select_result_format(const adc_conf_t *_adc);
static __attribute__((inline)) void adc_select_vol_ref(const adc_conf_t *_adc);
...
STD_ReturnType ADC_Init(const adc_conf_t *_adc){
    ...
    if(_adc == ((void*)0)) ret = (STD_ReturnType)0x00;
    else{
        (ADCON0bits.ADON = 0);
...
STD_ReturnType ADC_Is_Conversion_done(const adc_conf_t *_adc, uint8 *conversion_status){
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if(_adc == ((void*)0) || conversion_status == ((void*)0)) ret = (STD_ReturnType)0x00;
    else{
...
STD_ReturnType ADC_GetConversion_Status_Result(const adc_conf_t *_adc, uint16 *converstion_result){
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if(_adc == ((void*)0) || converstion_result == ((void*)0)) ret = (STD_ReturnType)0x00;
    else{
        if(_adc->format_status == 0x00U){
...
STD_ReturnType ADC_GetConversion_Blocking(const adc_conf_t *_adc, adc_select_channel_t adc_channel, uint16 *conversion_result){
    ...
    if(_adc == ((void*)0) || conversion_result == ((void*)0)) ret = (STD_ReturnType)0x00;
    else{

...
# 1 "./../GPIO Driver/MCAL_Layer/hal_gpio.h" 1
# 12 "./../GPIO Driver/MCAL_Layer/hal_gpio.h"
# 1 "./../GPIO Driver/MCAL_Layer/std_types.h" 1
# 13 "./../GPIO Driver/MCAL_Layer/std_types.h"
# 1 "./../GPIO Driver/MCAL_Layer/std_libraries.h" 1
# 13 "./../GPIO Driver/MCAL_Layer/std_libraries.h"
...
# 13 "./../GPIO Driver/MCAL_Layer/std_libraries.h" 2
...
# 14 "./../GPIO Driver/MCAL_Layer/std_libraries.h" 2
...
# 15 "./../GPIO Driver/MCAL_Layer/std_libraries.h" 2
...
# 16 "./../GPIO Driver/MCAL_Layer/std_libraries.h" 2
# 13 "./../GPIO Driver/MCAL_Layer/std_types.h" 2

# 1 "./../GPIO Driver/MCAL_Layer/compiler.h" 1
# 14 "./../GPIO Driver/MCAL_Layer/std_types.h" 2
...
# 12 "./../GPIO Driver/MCAL_Layer/hal_gpio.h" 2


# 1 "./../GPIO Driver/MCAL_Layer/device_config.h" 1
# 14 "./../GPIO Driver/MCAL_Layer/hal_gpio.h" 2

# 1 "./../GPIO Driver/MCAL_Layer/GPIO/hal_gpio_cfg_inter.h" 1
# 15 "./../GPIO Driver/MCAL_Layer/hal_gpio.h" 2
# 41 "./../GPIO Driver/MCAL_Layer/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 90 "./../GPIO Driver/MCAL_Layer/hal_gpio.h"
...
# 1 "./MCAL_Layer/Interrupt/hal_internal_interrupt.h" 1
# 13 "./MCAL_Layer/Interrupt/hal_internal_interrupt.h"
...
# 13 "./MCAL_Layer/Interrupt/hal_internal_interrupt.h" 2
# 16 "./timer1.h" 2
# 62 "./timer1.h"
typedef struct{
...
static void(*TIMER1_InterruptHandler)(void) = ((void*)0);
...
static __attribute__((inline)) void Timer1_mode_select(const timer1_t *_timer){
    if((_timer->timer1_mode) == 0){
        (T1CONbits.TMR1CS = 0);
    }else{
        (T1CONbits.TMR1CS = 1);
        if((_timer->timer1_counter_mode) == 0){
            (T1CONbits.T1SYNC = 0);
        }else{
            (T1CONbits.T1SYNC = 1);
        }

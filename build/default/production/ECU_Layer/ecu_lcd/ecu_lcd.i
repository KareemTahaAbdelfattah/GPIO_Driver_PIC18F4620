...
# 2 "<built-in>" 2
# 1 "ECU_Layer/ecu_lcd/ecu_lcd.c" 2
...
# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio.h" 1
# 12 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio.h"
# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/std_types.h" 1
# 13 "ECU_Layer/ecu_lcd/../../MCAL_Layer/std_types.h"
# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/std_libraries.h" 1
# 13 "ECU_Layer/ecu_lcd/../../MCAL_Layer/std_libraries.h"
...
# 13 "ECU_Layer/ecu_lcd/../../MCAL_Layer/std_libraries.h" 2
...
# 14 "ECU_Layer/ecu_lcd/../../MCAL_Layer/std_libraries.h" 2
...
# 15 "ECU_Layer/ecu_lcd/../../MCAL_Layer/std_libraries.h" 2
...
# 16 "ECU_Layer/ecu_lcd/../../MCAL_Layer/std_libraries.h" 2
# 13 "ECU_Layer/ecu_lcd/../../MCAL_Layer/std_types.h" 2

# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/compiler.h" 1
# 14 "ECU_Layer/ecu_lcd/../../MCAL_Layer/std_types.h" 2
...
# 12 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio.h" 2


# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/device_config.h" 1
# 14 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio.h" 2

# 1 "ECU_Layer/ecu_lcd/../../MCAL_Layer/GPIO/hal_gpio_cfg_inter.h" 1
# 15 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio.h" 2
# 41 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 90 "ECU_Layer/ecu_lcd/../../MCAL_Layer/hal_gpio.h"
...
# 13 "ECU_Layer/ecu_lcd/ecu_lcd.h" 2
...
# 9 "ECU_Layer/ecu_lcd/ecu_lcd.c" 2
# 20 "ECU_Layer/ecu_lcd/ecu_lcd.c"
...
STD_ReturnType convert_byte_to_string(uint8 value, uint8 *str){
    ...
    if(value == ((void*)0)) ret = (STD_ReturnType)0x00;
    else{
        memset(str, '\0', 4);
        sprintf(str, "%i", value);
    }
...
STD_ReturnType lcd_4_bit_initialize(const ch_lcd_4bit_t *lcd){
    STD_ReturnType ret = (STD_ReturnType)0x01;
    if(lcd == ((void*)0)) ret = (STD_ReturnType)0x00;
    else{
        ...
        _delay(200);
        lcd_4_bit_send_command(lcd, 0x38);
        _delay(50);
        lcd_4_bit_send_command(lcd, 0x38);
        _delay(15);
        lcd_4_bit_send_command(lcd, 0x38);
        lcd_4_bit_send_command(lcd, 0x01);
        lcd_4_bit_send_command(lcd, 0x02);
        lcd_4_bit_send_command(lcd, 0x06);
        lcd_4_bit_send_command(lcd, 0x0C);
        lcd_4_bit_send_command(lcd, 0x28);
...
STD_ReturnType lcd_4_bit_send_custom_char(const ch_lcd_4bit_t *lcd, uint8 row, uint8 column ,const uint8 _chr[], uint8 pos){
    ...
    if(lcd == ((void*)0)) ret = (STD_ReturnType)0x00;
        ...
        lcd_4_bit_send_command(lcd, ((0x40) + pos * 8));
        for(int i = 0; i < 8; i++){
...
STD_ReturnType lcd_8_bit_initialize(const ch_lcd_8bit_t *lcd){
    ...
    if(lcd == ((void*)0)) ret = (STD_ReturnType)0x00;
        ...
        _delay(200);
        lcd_8_bit_send_command(lcd, 0x38);
        _delay(50);
        lcd_8_bit_send_command(lcd, 0x38);
        _delay(15);
        lcd_8_bit_send_command(lcd, 0x38);
        lcd_8_bit_send_command(lcd, 0x01);
        lcd_8_bit_send_command(lcd, 0x02);
        lcd_8_bit_send_command(lcd, 0x06);
        lcd_8_bit_send_command(lcd, 0x0C);
        lcd_8_bit_send_command(lcd, 0x38);
    }
    return ret;
}
...
STD_ReturnType lcd_8_bit_send_custom_char(const ch_lcd_8bit_t *lcd, uint8 row, uint8 column ,const uint8 _chr[], uint8 pos){
    ...
    if(lcd == ((void*)0)) ret = (STD_ReturnType)0x00;
        ...
        lcd_8_bit_send_command(lcd, ((0x40) + pos * 8));
        for(int i = 0; i < 8; i++){
